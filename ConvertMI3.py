...
coco_input_folder = '/home/superorange5/data/coco/train2014'
MI3_folder = '/home/superorange5/MI3_dataset/MI3_dataset/JPEGImages/'
MI3_output_folder = '/home/superorange5/MI3_dataset/MI3_FDA/'

if not os.path.exists(MI3_output_folder):
    os.makedirs(MI3_output_folder)

MI3_list = os.listdir(MI3_folder)
coco_list = os.listdir(coco_input_folder)

for idx in range(min(len(MI3_list),len(coco_list))):
    print(idx)
    ...
    target_img = os.path.join(coco_input_folder,coco_filename)
    src_img = os.path.join(MI3_folder,MI3_filename)
    ...
    scipy.misc.toimage(src_in_trg, cmin=0.0, cmax=255.0).save(os.path.join(MI3_output_folder,MI3_filename))
